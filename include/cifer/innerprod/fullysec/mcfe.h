...
/**
 * cfe_mcfe_client represents a client in a decentralized multi-client scheme.
 */
typedef struct cfe_mcfe_client {
    size_t idx;
...
/**
 * Configures a new client for the mcfe scheme.
 *
 ...
 *
 * @param c A pointer to an instance of the scheme (*initialized* cfe_mcfe_client
 * struct)
 */
...
/**
 * Configures a new functional encryption key share for the mcfe scheme.
 *
 * @param fe_key_part A pointer to an uninitialized cfe_vec_G2 vec representing the share
 */
void cfe_mcfe_fe_key_part_init(cfe_vec_G2 *fe_key_part);
 ...
 */
void cfe_mcfe_derive_fe_key_part(cfe_vec_G2 *fe_key_part, cfe_mcfe_client *c, cfe_vec *y);
 ...
 * @return Error code
 */
cfe_error cfe_mcfe_decrypt(mpz_t res, ECP_BN254 *ciphers, cfe_vec_G2 *key_shares,
